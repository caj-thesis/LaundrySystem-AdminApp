...
import 'change_price_model.dart';
export 'change_price_model.dart';

class ChangePriceWidget extends StatefulWidget {
  const ChangePriceWidget({super.key});

  @override
  State<ChangePriceWidget> createState() => _ChangePriceWidgetState();
}

class _ChangePriceWidgetState extends State<ChangePriceWidget> {
  late ChangePriceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChangePriceModel());
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    Align(
                      alignment: AlignmentDirectional(-9.45, 0.0),
                      child: Column(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await containerSettingsRecord!
                                            ...
                                            clothesPrice: double.tryParse(_model
                                                .clothesFieldTextController
                                                .text),
                                            bedSheetPrice: double.tryParse(_model
                                                .bedSheetsFieldTextController
                                                .text),
                                          ));
                                        },
