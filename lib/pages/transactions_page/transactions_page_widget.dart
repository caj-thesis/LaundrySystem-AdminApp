                  ...
                  StreamBuilder<List<TransactionsRecord>>(
                    stream: queryTransactionsRecord(
                      queryBuilder: (transactionsRecord) => transactionsRecord
                          .where(
                            'type',
                            isEqualTo: _model.laundryTypeChipsValue != ''
                                ? _model.laundryTypeChipsValue
                                : null,
                          )
                          .where(
                            'laundryStatus',
                            isEqualTo: _model.laundryStatusChipsValue != ''
                                ? _model.laundryStatusChipsValue
                                : null,
                          )
                          .where(
                            'status',
                            isEqualTo: _model.paymentStatusChipsValue != ''
                                ? _model.paymentStatusChipsValue
                                : null,
                          )
                          .orderBy('droppedAt'),
                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(-1.0, 0.0),
                                child: Text(
                                  'View and manage all locker-based laundry service logs.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
