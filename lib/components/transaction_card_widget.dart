...
class TransactionCardWidget extends StatefulWidget {
  ...
  final TransactionsRecord? transactionParam;
    ...
    return StreamBuilder<List<TransactionsRecord>>(
      stream: queryTransactionsRecord(
        queryBuilder: (transactionsRecord) => transactionsRecord.where(
          'transactionId',
          isEqualTo: widget.transactionParam?.transactionId,
        ),
        singleRecord: true,
      ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Stack(
                  children: [
                    if (containerTransactionsRecord?.laundryStatus == 'Dropped')
                      Padding(
                        padding:
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(0x1CFF0019),
                            borderRadius: BorderRadius.circular(24.0),
                            shape: BoxShape.rectangle,
                            border: Border.all(
                              color: Color(0x64DC3545),
                              width: 2.0,
                            ),
                          ),
                          child: Padding(
                    ...
                    if (containerTransactionsRecord?.laundryStatus == 'Washing')
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 5.0),
                        child: Container(
                    ...
                    if ((containerTransactionsRecord?.laundryStatus ==
                            'Done') &&
                        (containerTransactionsRecord?.status == 'completed'))
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 5.0),
                        child: Container(
                    ...
                    if ((containerTransactionsRecord?.laundryStatus ==
                            'Done') &&
                        (containerTransactionsRecord?.status == 'paid_pending'))
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 5.0),
                        child: Container(
                    ...
                    children: [
                      TextSpan(
                        text: valueOrDefault<String>(
                          containerTransactionsRecord?.transactionId,
                          'TRX-0000000000',
                        ),
                        style:
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<OverdueLogsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<OverdueLogsRecord> columnOverdueLogsRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final columnOverdueLogsRecord =
                              columnOverdueLogsRecordList.isNotEmpty
                                  ? columnOverdueLogsRecordList.first
                                  : null;
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              if (columnOverdueLogsRecord != null)
                                Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    Icon(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          containerTransactionsRecord?.pin,
                                          '0000',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          containerTransactionsRecord?.weight
                                              .toString(),
                                          '0.0',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          containerTransactionsRecord?.price
                                              .toString(),
                                          '0',
                                        ),
                                        style: FlutterFlowTheme.of(context)
