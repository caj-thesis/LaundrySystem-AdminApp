...
import 'laundry_card_model.dart';
export 'laundry_card_model.dart';
...
class _LaundryCardWidgetState extends State<LaundryCardWidget> {
  late LaundryCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LaundryCardModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<LockersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LockersRecord> containerLockersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final containerLockersRecord = containerLockersRecordList.isNotEmpty
            ? containerLockersRecordList.first
            : null;
                              ...
                              onPressed: () async {
                                var confirmDialogResponse =
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text('Ready for Pick-Up'),
                                              content: Text(
                                                  'The laundry are ready for pick-up.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                              ...
                              if (containerLockersRecord?.action == 'lock') {
                                var confirmDialogResponse =
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text('Unlock Locker'),
                                              content: Text(
                                                  'This button will unlock the locker'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                                ...
                                var confirmDialogResponse =
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text('Lock  Locker'),
                                              content: Text(
                                                  'This button will lock the locker.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
