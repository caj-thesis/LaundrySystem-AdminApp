...
class SalesPageWidget extends StatefulWidget {
  ...
  static String routeName = 'SalesPage';
  static String routePath = '/salesPage';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                alignment: AlignmentDirectional(-1.0, 0.0),
                                child: Text(
                                  'Monitor revenue, payments, and transaction history seamlessly.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, salesListIndex) {
                                        final salesListItem =
                                            salesList[salesListIndex];
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              TransactionItemWidget.routeName,
                                              queryParameters: {
                                                'transactionID': serializeParam(
                                                  salesListItem.transactionId,
                                                  ParamType.String,
                                                ),
                                              }.withoutNulls,
